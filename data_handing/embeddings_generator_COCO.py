...
def Extract_embeddings(model,text_data):
    ...
    text_data = text_data["annotations"]
    out_data = []
...
def main():
    ...
    #fsd_path
    with open(os.path.join(args.dataset_path,"captions_train2014.json"), 'r', encoding='utf-8') as file:
    ...
    with open(os.path.join(args.dataset_path,"coco_data.pkl"), 'wb') as f:
